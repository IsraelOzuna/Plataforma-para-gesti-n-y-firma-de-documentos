<?php
class SubirArchivoController extends CI_Controller {
    ...
    public function registrarArchivo(){
        ...
        {
            redirect('SubirArchivoController/index');
        }else
        {
            $this->Documento_Model->registrarDocumento($datos);
            $archivo = 'documento';
            $acta['file_name'] = $datos['nombre'];
            $acta['upload_path'] = 'C:/Users/iro19/Documents/7mo/Web/Practicas/CodeIgniter/archivos';
